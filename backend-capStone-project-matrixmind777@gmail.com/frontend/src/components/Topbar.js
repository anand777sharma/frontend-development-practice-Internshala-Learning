...
const Topbar = () => {
    return (
        <div>
            <div className="container d-flex justify-content-between px-3 bg-light py-2 d-lg-none ">
                <a className="text-decoration-none border-0 fs-5 mt-1 text-dark">
                    <Profile size="45px" source="https://images.pexels.com/photos/1081685/pexels-photo-1081685.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="profile" /> </a>
                <a className="text-decoration-none border-0 fs-5 mt-1 text-dark">
